            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3" align="center" style="padding-top:7px;padding-right:32px;padding-bottom:0px;padding-left:32px;background:#ffffff">
                        <p style="color:#323130;font-size:16px;font-weight:400;line-height:18px;margin:0;max-width:400px;padding-bottom:29px;text-align:center">Vendor Registration Approved</p>
                    </td>
                ...
                <tr>
                    <td colspan="1" style="background-color:#ffffff;border-top:1px solid #dedede;padding:29px 20px 28px" align="center">
                        ...
                        <p style="font-size:16px;line-height:20px;color:#323130;font-weight:400;margin:0px;padding:0px;text-align:center;max-width:560px">
                            <b>{{ $vendor->name }}</b>,<br/><br/>Your account is now active. next step is to complete profile data and upload documents. After your profile data complete, start join our tender.
                        </p>
                        <table role="presentation" align="center" border="0" cellpadding="3" width="340" cellspacing="0" style="font-size:16px;line-height:20px;color:#323130;font-weight:400;margin:32px 0 0 0;max-width:340px;overflow:hidden;background:#ffffff">
                            <tbody>
                                <tr>
                                    <td>Username:</td><td>{{ $vendor->picEmail }}</td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="1" style="padding:32px 0px;height:40px;background-color:#ffffff;width:650px;text-align:center;border-bottom:none">
                                        ...
                                        <a href="{{ getenv('APP_URL') }}" style="background-color:#0078d4;border-color:#0078d4;border-radius:2px;border-style:solid;color:#ffffff;display:inline-block;font-size:16px;text-decoration:none;text-align:center;line-height:46px;width:223px" target="_blank">
                                            Login
                                        </a>
